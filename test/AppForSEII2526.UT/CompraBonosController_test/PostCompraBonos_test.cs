...
namespace AppForSEII2526.UT.CompraBonosController_test
{
    public class PostCompraBonos_test: AppForSEII25264SqliteUT
    {
        public PostCompraBonos_test()
        {
            ...
            var compraBono = new CompraBono(null, "Adolfo", "Escribano", "Martinez", 3, DateTime.Now, EnumMetodosPago.PayPal, 5, 15, new List<BonosComprados>());
        ...
        public async Task CrearCompra_Exito_test()
        {
            ...
            compraBonosForCreate.ItemsCompraBono.Add(new BonosItemDTO(1, 2, 2, "Bono1", "Completo", 1));

            //we expected to have a new purchase in the database
            var esperadoCompraBonoDetailDTO = new BonosDetailDTO(4, "Adolfo", "Escribano", "Martinez", EnumMetodosPago.PayPal, DateTime.Now, 2, new List<BonosItemDTO>());
            esperadoCompraBonoDetailDTO.ItemsBono.Add(new BonosItemDTO(1, 2, 2, "Bono1", "Completo", 1));
